...
class DepenseSearchForm(forms.Form):
    ...
    statut = forms.ChoiceField(
        choices=[('', 'Tous')] + [('en_attente', 'En attente de validation'), ('validee', 'Validée'), ('rejetee', 'Rejetée')],
        required=False,
        widget=forms.Select(attrs={'class': 'form-select'})
    )
...
class RevenuSearchForm(forms.Form):
    ...
    statut = forms.ChoiceField(
        choices=[('', 'Tous')] + [('en_attente', 'En attente de validation'), ('validee', 'Validée'), ('annulee', 'Annulée')],
        required=False,
        widget=forms.Select(attrs={'class': 'form-select'})
    )
...
class FactureSearchForm(forms.Form):
    ...
    statut = forms.ChoiceField(
        choices=[('', 'Tous')] + [('en_attente', 'En attente de paiement'), ('partiellement_payee', 'Partiellement payée'), ('payee', 'Payée'), ('annulee', 'Annulée'), ('en_retard', 'En retard')],
        required=False,
        widget=forms.Select(attrs={'class': 'form-select'})
    )
